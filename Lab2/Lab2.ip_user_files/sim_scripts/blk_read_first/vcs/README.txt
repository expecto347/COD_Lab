...
#
# Generated by export_simulation on Tue Apr 11 22:23:48 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './blk_read_first.sh' script.

./blk_read_first.sh -reset_run
...
./blk_read_first.sh -noclean_files

For more information on the script, please type './blk_read_first.sh -help'.
