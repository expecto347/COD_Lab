...
HD_PWD='C:/Users/expecto/Desktop/COD_Lab/Lab2/Lab2.runs/blk_write_first_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_write_first.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_write_first.tcl
