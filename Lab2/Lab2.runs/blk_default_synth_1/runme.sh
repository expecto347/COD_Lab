...
HD_PWD='C:/Users/expecto/Desktop/COD_Lab/Lab2/Lab2.runs/blk_default_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_default.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_default.tcl
