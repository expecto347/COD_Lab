...
HD_PWD='/root/COD_Lab/Lab6_pipeline/Lab6/Lab6.runs/main_memory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_memory.tcl
